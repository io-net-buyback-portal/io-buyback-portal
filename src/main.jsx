...
<footer><b>IO Buyback Portal</b><span>Web3 allocation interface prototype · © 2026</span></footer>{modal&&<div className="overlay"onClick={()=>setModal(false)}><div className="modal"onClick={e=>e.stopPropagation()}
